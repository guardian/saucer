...
h=Object.prototype,e=f.forEach,n=f.slice,u=h.hasOwnProperty,q=h.toString,x=m.Popcorn,v=[],o=false,z={events:{hash:{},apis:{}}},J=function(){return m.requestAnimationFrame||m.webkitRequestAnimationFrame||m.mozRequestAnimationFrame||m.oRequestAnimationFrame||m.msRequestAnimationFrame||function(a){m.setTimeout(a,16)}}(),E={put:function(a){for(var c in a)if(a.hasOwnProperty(c))this[c]=a[c]}},g=function(a,c){return new g.p.init(a,c||null)};g.version="8c632b4";g.isSupported=true;g.instances=[];g.p=g.prototype=
...
function(a){return a.data.trackRefs};g.getTrackEvent=function(a,c){return a.data.trackRefs[c]};g.getTrackEvent.ref=function(a,c){return a.data.trackRefs[c]};g.getLastTrackEventId=function(a){return a.data.history[a.data.history.length-1]};g.timeUpdate=function(a,c){var l=a.media.currentTime,j=a.data.trackEvents.previousUpdateTime,s=a.data.trackEvents,t=s.endIndex,y=s.startIndex,D=s.byStart.length,r=s.byEnd.length,M=g.registryByName,w,p,B;if(j<=l){for(;s.byEnd[t]&&s.byEnd[t].end<=l;){w=s.byEnd[t];
p=(j=w._natives)&&j.type;if(!j||M[p]||a[p]){if(w._running===true){w._running=false;B=a.data.running[p];B.splice(B.indexOf(w),1);if(!a.data.disabled[p]){j.end.call(a,c,w);a.emit("trackend",g.extend({},w,{plugin:p,type:"trackend",track:w}))}}t++}else{g.removeTrackEvent(a,w._id);return}}for(;s.byStart[y]&&s.byStart[y].start<=l;){w=s.byStart[y];p=(j=w._natives)&&j.type;if(!j||M[p]||a[p]){if(w.end>l&&w._running===false){w._running=true;a.data.running[p].push(w);if(!a.data.disabled[p]){j.start.call(a,c,
...
p);this.emit("tracksetup",g.extend({},p,{plugin:p._natives.type,type:"tracksetup",track:p}))}}this.data.trackEvents.add(p);k.start(this,p);this.timeUpdate(this,null,true);p._id&&g.addTrackEvent.ref(this,p)}else g.addTrackEvent(this,p);g.forEach(w,function(N,C){s.indexOf(C)===-1&&this.on(C,N)},this);return this};g.p[a]=y[a]=function(w,p){var B,R;if(w&&!p)p=w;else if(B=this.getTrackEvent(w)){R=p;var K={},N;for(N in B)if(u.call(R,N)&&u.call(B,N))K[N]=B[N];if(B._natives._update){this.data.trackEvents.remove(B);
...
function(){}}})(window,window.document);(function(m){var i=function(k,d){k=k||m.nop;d=d||m.nop;return function(){k.apply(this,arguments);d.apply(this,arguments)}};m.player=function(k,d){if(!m[k]){d=d||{};var b=function(f,h,e){e=e||{};var n=new Date/1E3,u=n,q=0,x=0,v=1,o=false,z={},J=typeof f==="string"?m.dom.find(f):f,E={};Object.prototype.__defineGetter__||(E=J||document.createElement("div"));for(var g in J)if(!(g in E))if(typeof J[g]==="object")E[g]=J[g];else if(typeof J[g]==="function")E[g]=function(A){return"length"in J[A]&&!J[A].call?
...
defaultPlaybackRate:{get:function(){return 1},configurable:true},style:{get:function(){return this.parentNode.style},configurable:true},id:{get:function(){return this.parentNode.id},configurable:true}});return b}})(Popcorn,window.document);(function(m,i,k){function d(){if(i.jwplayer){n=true;for(var x=q.length;x--;){q[x]();delete q[x]}}else setTimeout(d,100)}function b(){if(!u){if(!i.jwplayer){var x=k.createElement("script");x.src="https://jwpsrv.com/library/zaIF4JI9EeK2FSIACpYGxA.js";var v=k.getElementsByTagName("script")[0];v.parentNode.insertBefore(x,v)}u=true;d()}return n}function f(x){q.unshift(x)}function h(x){function v(L){C.unshift(L)}function o(){var L=K.getDuration();if(L==-1)setTimeout(o,0);else{r.duration=L;y.dispatchEvent("durationchange");
M=true;r.readyState=y.HAVE_METADATA;y.dispatchEvent("loadedmetadata");y.dispatchEvent("loadeddata");r.readyState=y.HAVE_FUTURE_DATA;y.dispatchEvent("canplay");for(B=true;C.length;){C[0]();C.shift()}r.readyState=y.HAVE_ENOUGH_DATA;y.dispatchEvent("canplaythrough")}}function z(){if(w)w=false;else if(H){H=false;o()}else l()}function J(){if(r.seeking){r.ended=false;r.seeking=false;y.dispatchEvent("timeupdate");y.dispatchEvent("seeked");y.dispatchEvent("canplay");y.dispatchEvent("canplaythrough")}}function E(){K.onPause(z);
K.onTime(function(){if(!r.ended&&!r.seeking){r.currentTime=K.getPosition();y.dispatchEvent("timeupdate")}});K.onSeek(J);K.onPlay(function(){if(!r.ended)if(S){S=false;if(r.autoplay||!r.paused){r.paused=false;v(a);o()}else{p=H=true;K.pause(true)}}else if(p){p=false;w=true;K.pause(true)}else a()});K.onBufferChange(c);K.onComplete(j);K.play(true)}function g(L){var T={name:"MediaError"};T.message=L.message;T.code=L.code||5;r.error=T;y.dispatchEvent("error")}function G(L){if(y._canPlaySrc(L)){var T=y._util.parseUri(L).queryKey;
r.controls=T.controls=T.controls||r.controls;r.src=L;if(b()){if(M)M&&K&&K.destroy();T={width:"100%",height:"100%",controls:r.controls};if(typeof L=="string")T.file=L;else T.sources=L;jwplayer(D.id).setup(T);K=jwplayer(D.id);K.onReady(E);K.onError(g);jwplayer.utils.log=function(F,V){if(typeof console!=="undefined"&&typeof console.log!=="undefined")V?console.log(F,V):console.log(F);F==="No suitable players found and fallback enabled"&&g({message:F,code:4})};r.networkState=y.NETWORK_LOADING;y.dispatchEvent("loadstart");
y.dispatchEvent("progress")}else f(function(){G(L)})}else{r.error={name:"MediaError",message:"Media Source Not Supported",code:MediaError.MEDIA_ERR_SRC_NOT_SUPPORTED};y.dispatchEvent("error")}}function A(L){r.currentTime=L;if(B){O();K.seek(L)}else v(function(){O();K.seek(L)})}function O(){r.seeking=true;if(r.paused)p=true;y.dispatchEvent("seeking")}function a(){r.paused=false;if(N){N=false;if(r.loop&&!R||!r.loop){R=true;y.dispatchEvent("play")}y.dispatchEvent("playing")}}function c(){y.dispatchEvent("progress")}
function l(){r.paused=true;if(!N){N=true;y.dispatchEvent("pause")}}function j(){if(r.loop)A(0);else{r.ended=true;l();y.dispatchEvent("timeupdate");y.dispatchEvent("ended")}}function s(L){r.volume=L;if(B){K.setVolume(r.volume*100);y.dispatchEvent("volumechange")}else v(function(){s(r.volume)})}function t(L){r.muted=L;if(B){K.setMute(L);y.dispatchEvent("volumechange")}else v(function(){t(r.muted)})}if(!i.postMessage)throw"ERROR: HTMLJWPlayerVideoElement requires window.postMessage";var y=new m._MediaElementProto,
D=typeof x==="string"?k.querySelector(x):x,r={src:e,networkState:y.NETWORK_EMPTY,readyState:y.HAVE_NOTHING,seeking:false,autoplay:e,preload:e,controls:false,loop:false,poster:e,volume:1,muted:false,currentTime:0,duration:NaN,ended:false,paused:true,error:null},M=false,w=false,p=false,B=false,R=false,K,N=true,C=[],S=true,H=false;y._eventNamespace=m.guid("HTMLJWPlayerVideoElement::");y.parentNode=D;y._util.type="JWPlayer";y.play=function(){y.dispatchEvent("play");r.paused=false;if(B){if(r.ended){A(0);
r.ended=false}K.play(true)}else v(function(){y.play()})};y.pause=function(){r.paused=true;B?K.pause(true):v(function(){y.pause()})};Object.defineProperties(y,{src:{get:function(){return r.src},set:function(L){L&&L!==r.src&&G(L)}},autoplay:{get:function(){return r.autoplay},set:function(L){r.autoplay=y._util.isAttributeSet(L)}},loop:{get:function(){return r.loop},set:function(L){r.loop=y._util.isAttributeSet(L)}},width:{get:function(){return y.parentNode.offsetWidth}},height:{get:function(){return y.parentNode.offsetHeight}},
currentTime:{get:function(){return r.currentTime},set:function(L){A(L)}},duration:{get:function(){return K.getDuration()}},ended:{get:function(){return r.ended}},paused:{get:function(){return r.paused}},seeking:{get:function(){return r.seeking}},readyState:{get:function(){return r.readyState}},networkState:{get:function(){return r.networkState}},volume:{get:function(){return r.volume},set:function(L){if(L<0||L>1)throw"Volume value must be between 0.0 and 1.0";s(L)}},muted:{get:function(){return r.muted},
set:function(L){t(y._util.isAttributeSet(L))}},error:{get:function(){return r.error}},buffered:{get:function(){return{start:function(L){if(L===0)return 0;throw"INDEX_SIZE_ERR: DOM Exception 1";},end:function(L){if(L===0){L=K.getDuration();if(!L)return 0;return L*(K.getBuffer()/100)}throw"INDEX_SIZE_ERR: DOM Exception 1";},length:1}}}});y._canPlaySrc=m.HTMLJWPlayerVideoElement._canPlaySrc;y.canPlayType=m.HTMLJWPlayerVideoElement.canPlayType;return y}var e="",n=false,u=false,q=[];m.HTMLJWPlayerVideoElement=
function(x){return new h(x)};m.HTMLJWPlayerVideoElement._canPlaySrc=function(){return"probably"};m.HTMLJWPlayerVideoElement.canPlayType=function(){return"probably"}})(Popcorn,window,document);(function(m,i,k){function d(){var z;if(YT.loaded)for(x=true;o.length;){z=o.shift();z()}else setTimeout(d,250)}function b(){var z;if(!v){if(i.YT)d();else{z=k.createElement("script");z.addEventListener("load",d,false);z.src="https://www.youtube.com/iframe_api";k.head.appendChild(z)}v=true}return x}function f(z){o.push(z)}function h(z){function J(I){W.push(I)}function E(){Q.pauseVideo();j("play",E);l("play",K)}function g(){l("pause",N);j("pause",g)}function G(){var I=function(){if(Q.isMuted()){l("play",
...
{src:{get:function(){return F.src},set:function(I){I&&I!==F.src&&D(I)}},autoplay:{get:function(){return F.autoplay},set:function(I){F.autoplay=H._util.isAttributeSet(I)}},loop:{get:function(){return F.loop},set:function(I){F.loop=H._util.isAttributeSet(I)}},width:{get:function(){return H.parentNode.offsetWidth}},height:{get:function(){return H.parentNode.offsetHeight}},currentTime:{get:function(){return F.currentTime},set:function(I){w(I)}},duration:{get:function(){return F.duration}},ended:{get:function(){return F.ended}},
...
setInterval(q,o._util.TIMEUPDATE_MS)}}else e(function(){o.play()})};o.pause=function(){if(E){g.pause();G.paused||x()}else e(function(){o.pause()})};Object.defineProperties(o,{src:{get:function(){return G.src},set:function(a){if(a&&a!==G.src)if(o._canPlaySrc(a)){G.src=a;if(E)if(E&&g){g.pause();g=null;z.removeChild(J);J=i.createElement("div")}J.width=G.width;J.height=G.height;z.appendChild(J);a=f.exec(a);g=new k({currentTime:+a[1],duration:+a[2],endedCallback:v});o.dispatchEvent("loadstart");o.dispatchEvent("progress");
...
function g(){r.paused=true;if(!w){w=true;clearInterval(R);t.dispatchEvent("pause")}}function G(){t.dispatchEvent("timeupdate")}function A(C){r.currentTime=C;C!==N&&t.dispatchEvent("timeupdate");N=C}function O(C){switch(C.type){case "loadProgress":t.dispatchEvent("progress");break;case "playProgress":A(C.data);break;case "play":if(!K){K=setInterval(a,h);r.loop&&t.dispatchEvent("play")}R=setInterval(G,t._util.TIMEUPDATE_MS);r.paused=false;if(w){w=false;r.loop||t.dispatchEvent("play");t.dispatchEvent("playing")}break;
...
true;if(!t){t=true;clearInterval(D);A.dispatchEvent("pause")}break;case "finish":if(c.loop){x(0);A.play()}else{c.ended=true;A.dispatchEvent("ended")}break;case "seek":o(parseFloat(p.data.seconds));c.seeking=false;A.dispatchEvent("timeupdate");A.dispatchEvent("seeked");A.dispatchEvent("canplay");A.dispatchEvent("canplaythrough")}}}}function E(){s.getCurrentTime()}function g(w){c.volume=w;if(l){s.setVolume(w);A.dispatchEvent("volumechange")}else u(function(){g(w)})}function G(w){if(l)if(w){c.muted=
c.volume;g(0)}else{c.muted=0;g(c.muted)}else{c.muted=w?1:0;u(function(){G(w)})}}if(!i.postMessage)throw"ERROR: HTMLVimeoVideoElement requires window.postMessage";var A=new m._MediaElementProto,O=typeof n==="string"?m.dom.find(n):n,a=k.createElement("iframe"),c={src:h,networkState:A.NETWORK_EMPTY,readyState:A.HAVE_NOTHING,seeking:false,autoplay:h,preload:h,controls:false,loop:false,poster:h,volume:1,muted:0,currentTime:0,duration:NaN,ended:false,paused:true,error:null},l=false,j=m.guid(),s,t=true,
y=[],D,r,M=0;A._eventNamespace=m.guid("HTMLVimeoVideoElement::");A.parentNode=O;A._util.type="Vimeo";A.play=function(){c.paused=false;l?s.play():u(function(){A.play()})};A.pause=function(){c.paused=true;l?s.pause():u(function(){A.pause()})};Object.defineProperties(A,{src:{get:function(){return c.src},set:function(w){if(w&&w!==c.src)if(A._canPlaySrc(w)){c.src=w;if(l)if(l&&s){clearInterval(r);s.pause();i.removeEventListener("message",J,false);O.removeChild(a);a=k.createElement("iframe")}l=false;w=A._util.parseUri(w);
var p=w.queryKey,B,R=["api=1","player_id="+j,"title=0","byline=0","portrait=0"];c.loop=p.loop==="1"||c.loop;delete p.loop;c.autoplay=p.autoplay==="1"||c.autoplay;delete p.autoplay;w=e+"/video/"+/\d+$/.exec(w.path)+"?";for(B in p)p.hasOwnProperty(B)&&R.push(encodeURIComponent(B)+"="+encodeURIComponent(p[B]));w+=R.join("&");a.id=j;a.style.width="100%";a.style.height="100%";a.frameBorder=0;a.webkitAllowFullScreen=true;a.mozAllowFullScreen=true;a.allowFullScreen=true;O.appendChild(a);a.src=w;i.addEventListener("message",
...
label:"API Key",optional:true},target:"flickr-container",height:{elem:"input",type:"text",label:"Height","default":"50px",optional:true},width:{elem:"input",type:"text",label:"Width","default":"50px",optional:true},padding:{elem:"input",type:"text",label:"Padding",optional:true},border:{elem:"input",type:"text",label:"Border","default":"5px",optional:true},numberofimages:{elem:"input",type:"number","default":4,label:"Number of Images"}}})})(Popcorn);(function(m,i){var k={};m.plugin("documentcloud",{manifest:{about:{name:"Popcorn Document Cloud Plugin",version:"0.1",author:"@humphd, @ChrisDeCairos",website:"http://vocamus.net/dave"},options:{start:{elem:"input",type:"number",label:"Start"},end:{elem:"input",type:"number",label:"End"},target:"documentcloud-container",width:{elem:"input",type:"text",label:"Width",optional:true},height:{elem:"input",type:"text",label:"Height",optional:true},src:{elem:"input",type:"url",label:"PDF URL","default":"http://www.documentcloud.org/documents/70050-urbina-day-1-in-progress.html"},
...
o=d.target,z=i.getElementById(o),J=i.createElement("div"),E=m.position(z),g=d.width||E.width;E=d.height||E.height;var G=d.sidebar||true,A=d.text||true,O=d.pdf||true,a=d.showAnnotations||true,c=d.zoom||700,l=d.search||true;if(!function(j){var s=false;m.forEach(h.viewers,function(t){if(t.api.getSchema().canonicalURL===j){q(t);t=k[d._key];d._containerId=t.id;t.num+=1;s=true;h.loaded=true}});return s}(d.url)){J.id=d._containerId=m.guid(o);o="#"+J.id;z.appendChild(J);e.trigger("documentready");h.load(v,
{width:g,height:E,sidebar:G,text:A,pdf:O,showAnnotations:a,zoom:c,search:l,container:o,afterLoad:d.page||d.aid?function(j){q(j);d._changeView(j);J.style.visibility="hidden";j.elements.pages.hide();x()}:function(j){q(j);x();J.style.visibility="hidden";j.elements.pages.hide()}})}}function f(){window.DV.loaded?b():setTimeout(f,25)}var h=window.DV=window.DV||{},e=this;if(h.loading)f();else{h.loading=true;h.recordHit="//www.documentcloud.org/pixel.gif";var n=i.createElement("link"),u=i.getElementsByTagName("head")[0];
...
"default":"Toronto, Ontario, Canada"},markers:{elem:"input",type:"text",label:"List Markers",optional:true}}})})(Popcorn);var googleCallback;
...
optional:true},onEnd:{elem:"input",type:"function",label:"onEnd"}}})})(Popcorn);(function(m){function i(b){return String(b).replace(/&(?!\w+;)|[<>"']/g,function(f){return d[f]||f})}function k(b,f){var h=b.container=document.createElement("div"),e=h.style,n=b.media,u=function(){var q=b.position();e.fontSize="18px";e.width=n.offsetWidth+"px";e.top=q.top+n.offsetHeight-h.offsetHeight-40+"px";e.left=q.left+"px";setTimeout(u,10)};h.id=f||"";e.position="absolute";e.color="white";e.textShadow="black 2px 2px 6px";e.fontWeight="bold";e.textAlign="center";u();b.media.parentNode.appendChild(h);
...
"//");i._iframe=document.createElement("iframe");i._iframe.setAttribute("width","100%");i._iframe.setAttribute("height","100%");i._iframe.id=i.id;i._iframe.src=i.src;i._iframe.style.display="none";k&&k.appendChild(i._iframe)},start:function(i,k){k._iframe.src=k.src;k._iframe.style.display="inline"},end:function(i,k){k._iframe.style.display="none"},_teardown:function(i){document.getElementById(i.target)&&document.getElementById(i.target).removeChild(i._iframe)}})})(Popcorn);(function(m){m.plugin("mustache",function(i){var k,d,b,f;m.getScript("http://mustache.github.com/extras/mustache.js");var h=!!i.dynamic,e=typeof i.template,n=typeof i.data,u=document.getElementById(i.target);i.container=u||document.createElement("div");if(e==="function")if(h)b=i.template;else f=i.template(i);else f=e==="string"?i.template:"";if(n==="function")if(h)k=i.data;else d=i.data(i);else d=n==="string"?JSON.parse(i.data):n==="object"?i.data:"";return{start:function(q,x){var v=function(){if(window.Mustache){if(k)d=
...
label:"Template"},data:{elem:"input",type:"text",label:"Data"},dynamic:{elem:"input",type:"checkbox",label:"Dynamic","default":true}}})})(Popcorn);(function(m){var i=1;m.plugin("timeline",function(k){var d=document.getElementById(k.target),b=document.createElement("div"),f,h=true;if(d&&!d.firstChild){d.appendChild(f=document.createElement("div"));f.style.width="inherit";f.style.height="inherit";f.style.overflow="auto"}else f=d.firstChild;b.style.display="none";b.id="timelineDiv"+i;k.direction=k.direction||"up";if(k.direction.toLowerCase()==="down")h=false;if(d&&f)h?f.insertBefore(b,f.firstChild):f.appendChild(b);i++;b.innerHTML="<p><span id='big' style='font-size:24px; line-height: 130%;' >"+
...
v.word.parentNode&&v._container.removeChild(v.word);i[v.target]&&!i[v.target].childElementCount&&o&&o.removeChild(i[v.target])&&delete i[v.target]}})})(Popcorn);document.addEventListener("click",function(m){m=m.target;if(m.nodeName==="A"||m.parentNode&&m.parentNode.nodeName==="A")Popcorn.instances.forEach(function(i){i.options.pauseOnLinkClicked&&i.pause()})},false);(function(m){m.parser("parseTTXT",function(i){var k={title:"",remote:"",data:[]},d=function(n){n=n.split(":");var u=0;try{return parseFloat(n[0],10)*60*60+parseFloat(n[1],10)*60+parseFloat(n[2],10)}catch(q){u=0}return u},b=function(n,u){var q={};q[n]=u;return q};i=i.xml.lastChild.lastChild;for(var f=Number.MAX_VALUE,h=[];i;){if(i.nodeType===1&&i.nodeName==="TextSample"){var e={};e.start=d(i.getAttribute("sampleTime"));e.text=i.getAttribute("text");if(e.text){e.end=f-0.001;h.push(b("subtitle",e))}f=
e.start}i=i.previousSibling}k.data=h.reverse();return k})})(Popcorn);(function(m){function i(e,n,u){var q=e.firstChild;e=k(e,u);u=[];for(var x;q;){if(q.nodeType===1)if(q.nodeName==="p")u.push(d(q,n,e));else if(q.nodeName==="div"){x=b(q.getAttribute("begin"));if(x<0)x=n;u.push.apply(u,i(q,x,e))}q=q.nextSibling}return u}function k(e,n){var u=e.getAttribute("region");return u!==null?u:n||""}function d(e,n,u){var q={};q.text=(e.textContent||e.text).replace(f,"").replace(h,"<br />");q.id=e.getAttribute("xml:id")||e.getAttribute("id");q.start=b(e.getAttribute("begin"),n);
q.end=b(e.getAttribute("end"),n);q.target=k(e,u);if(q.end<0){q.end=b(e.getAttribute("duration"),0);if(q.end>=0)q.end+=q.start;else q.end=Number.MAX_VALUE}return{subtitle:q}}function b(e,n){var u;if(!e)return-1;try{return m.util.toSeconds(e)}catch(q){for(var x=e.length-1;x>=0&&e[x]<="9"&&e[x]>="0";)x--;u=x;x=parseFloat(e.substring(0,u));u=e.substring(u);return x*({h:3600,m:60,s:1,ms:0.001}[u]||-1)+(n||0)}}var f=/^[\s]+|[\s]+$/gm,h=/(?:\r\n|\r|\n)/gm;m.parser("parseTTML",function(e){var n={title:"",
remote:"",data:[]};if(!e.xml||!e.xml.documentElement)return n;e=e.xml.documentElement.firstChild;if(!e)return n;for(;e.nodeName!=="body";)e=e.nextSibling;if(e)n.data=i(e,0);return n})})(Popcorn);(function(m){m.parser("parseSBV",function(i){var k={title:"",remote:"",data:[]},d=[],b=0,f=0,h=function(v){v=v.split(":");var o=v.length-1,z;try{z=parseInt(v[o-1],10)*60+parseFloat(v[o],10);if(o===2)z+=parseInt(v[0],10)*3600}catch(J){throw"Bad cue";}return z},e=function(v,o){var z={};z[v]=o;return z};i=i.text.split(/(?:\r\n|\r|\n)/gm);for(f=i.length;b<f;){var n={},u=[],q=i[b++].split(",");try{n.start=h(q[0]);for(n.end=h(q[1]);b<f&&i[b];)u.push(i[b++]);n.text=u.join("<br />");d.push(e("subtitle",n))}catch(x){for(;b<
f&&i[b];)b++}for(;b<f&&!i[b];)b++}k.data=d;return k})})(Popcorn);(function(m){m.parser("parseXML","XML",function(i){var k={title:"",remote:"",data:[]},d={},b=function(q){q=q.split(":");if(q.length===1)return parseFloat(q[0],10);else if(q.length===2)return parseFloat(q[0],10)+parseFloat(q[1]/12,10);else if(q.length===3)return parseInt(q[0]*60,10)+parseFloat(q[1],10)+parseFloat(q[2]/12,10);else if(q.length===4)return parseInt(q[0]*3600,10)+parseInt(q[1]*60,10)+parseFloat(q[2],10)+parseFloat(q[3]/12,10)},f=function(q){for(var x={},v=0,o=q.length;v<o;v++){var z=q.item(v).nodeName,
J=q.item(v).nodeValue,E=d[J];if(z==="in")x.start=b(J);else if(z==="out")x.end=b(J);else if(z==="resourceid")for(var g in E){if(E.hasOwnProperty(g))if(!x[g]&&g!=="id")x[g]=E[g]}else x[z]=J}return x},h=function(q,x){var v={};v[q]=x;return v},e=function(q,x,v){var o={};m.extend(o,x,f(q.attributes),{text:q.textContent||q.text});x=q.childNodes;if(x.length<1||x.length===1&&x[0].nodeType===3)if(v)d[o.id]=o;else k.data.push(h(q.nodeName,o));else for(q=0;q<x.length;q++)x[q].nodeType===1&&e(x[q],o,v)};i=i.documentElement.childNodes;
for(var n=0,u=i.length;n<u;n++)if(i[n].nodeType===1)i[n].nodeName==="manifest"?e(i[n],{},true):e(i[n],{},false);return k})})(Popcorn);(function(m){function i(b,f){var h=b.substr(10).split(","),e;e={start:k(h[f.start]),end:k(h[f.end])};if(e.start===-1||e.end===-1)throw"Invalid time";var n=v.call(q,/\{(\\[\w]+\(?([\w\d]+,?)+\)?)+\}/gi,""),u=n.replace,q;q=h.length;v=[];for(var x=f.text;x<q;x++)v.push(h[x]);q=v.join(",");var v=q.replace;e.text=u.call(n,/\\N/gi,"<br />");return e}function k(b){var f=b.split(":");if(b.length!==10||f.length<3)return-1;return parseInt(f[0],10)*3600+parseInt(f[1],10)*60+parseFloat(f[2],10)}function d(b,
f){var h={};h[b]=f;return h}m.parser("parseSSA",function(b){var f={title:"",remote:"",data:[]},h=[],e=0,n;b=b.text.split(/(?:\r\n|\r|\n)/gm);for(n=b.length;e<n&&b[e]!=="[Events]";)e++;var u=b[++e].substr(8).split(", "),q={},x,v;v=0;for(x=u.length;v<x;v++)if(u[v]==="Start")q.start=v;else if(u[v]==="End")q.end=v;else if(u[v]==="Text")q.text=v;for(;++e<n&&b[e]&&b[e][0]!=="[";)try{h.push(d("subtitle",i(b[e],q)))}catch(o){}f.data=h;return f})})(Popcorn);(function(m){function i(d,b){var f={};f[d]=b;return f}function k(d){d=d.split(":");try{var b=d[2].split(",");if(b.length===1)b=d[2].split(".");return parseFloat(d[0],10)*3600+parseFloat(d[1],10)*60+parseFloat(b[0],10)+parseFloat(b[1],10)/1E3}catch(f){return 0}}m.parser("parseSRT",function(d,b){var f={title:"",remote:"",data:[]},h=[],e=0,n=0,u,q,x,v,o;u=d.text.split(/(?:\r\n|\r|\n)/gm);for(x=u.length-1;x>=0&&!u[x];)x--;v=x+1;for(e=0;e<v;e++){o={};x=[];for(e=e;!u[e];)e++;e=e;o.id=parseInt(u[e++],10);
...
void 0;var v={};if(!x||x.indexOf("--\>")===-1)throw"Bad cue";q=x.replace(/--\>/," --\> ").split(/[\t ]+/);if(q.length<2)throw"Bad cue";v.id=x;v.start=i(q[0]);v.end=i(q[2]);for(u=v;h<e&&d[h];)n.push(d[h++]);u.text=n.join("<br />");f.push(k("subtitle",u))}catch(o){for(h=h;h<e&&d[h];)h++;h=h}}b.data=f;return b})})(Popcorn);(function(m){m.parser("parseJSON","JSON",function(i){var k={title:"",remote:"",data:[]};m.forEach(i.data,function(d){k.data.push(d)});return k})})(Popcorn);(function(m,i){var k=function(d,b){return typeof b==="string"&&i.HTMLYouTubeVideoElement._canPlaySrc(b)};i.player("youtube",{_canPlayType:k});i.youtube=function(d,b,f){typeof console!=="undefined"&&console.warn&&console.warn("Deprecated player 'youtube'. Please use Popcorn.HTMLYouTubeVideoElement directly.");var h=i.HTMLYouTubeVideoElement(d);d=i(h,f);setTimeout(function(){h.src=b},0);return d};i.youtube.canPlayType=k})(window,Popcorn);(function(m,i){i.player("soundcloud",{_canPlayType:function(k,d){return typeof d==="string"&&i.HTMLSoundCloudAudioElement._canPlaySrc(d)&&k.toLowerCase()!=="audio"}});i.soundcloud=function(k,d,b){typeof console!=="undefined"&&console.warn&&console.warn("Deprecated player 'soundcloud'. Please use Popcorn.HTMLSoundCloudAudioElement directly.");var f=i.HTMLSoundCloudAudioElement(k);k=i(f,b);setTimeout(function(){f.src=d},0);return k}})(window,Popcorn);(function(m,i){i.player("vimeo",{_canPlayType:function(k,d){return typeof d==="string"&&i.HTMLVimeoVideoElement._canPlaySrc(d)}});i.vimeo=function(k,d,b){typeof console!=="undefined"&&console.warn&&console.warn("Deprecated player 'vimeo'. Please use Popcorn.HTMLVimeoVideoElement directly.");var f=i.HTMLVimeoVideoElement(k);k=i(f,b);setTimeout(function(){f.src=d},0);return k}})(window,Popcorn);
